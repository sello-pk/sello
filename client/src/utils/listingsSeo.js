...
export const cityLandingContent = {
  ...
  quetta: {
    priceTable: {
      title: "Used Cars Price in Quetta",
      rows: [
        { model: "Suzuki Alto", priceRange: "Varies by model, year and condition" },
        { model: "Toyota Corolla", priceRange: "Varies by model, year and condition" },
        { model: "Honda City", priceRange: "Varies by model, year and condition" },
    ...
    intro:
      "Used car prices in Quetta depend on the model, year, mileage, variant and overall condition. Buyers can compare different vehicles to find an option that suits their budget and driving requirements.",
    sections: [
      {
        heading: "Used Cars for Sale in Quetta",
        paragraphs: [
          "Looking for cars for sale in Quetta? Explore a variety of used cars from different brands and price categories. Whether you need a fuel-efficient car for daily travel, a family vehicle or a car for longer journeys, you can compare available options.",
          "Quetta buyers can explore hatchbacks, sedans and SUVs according to their needs. Check the vehicle's condition, documents, registration and ownership details before purchasing.",
        ],
      },
      {
        heading: "Find the Right Used Car in Quetta",
        paragraphs: [
          "Choosing a used car in Quetta starts with understanding your budget and requirements. Consider the model year, mileage, fuel type, transmission and maintenance needs before shortlisting a vehicle.",
          "You can also compare different listings, inspect the car and verify its documents before finalizing a deal. These steps can help you choose a suitable used car.",
        ],
      },
    ],
    faqs: [
      {
        question: "What types of used cars are available in Quetta?",
        answer:
          "You can find hatchbacks, sedans, SUVs and other used cars in different price categories.",
      },
      {
  ...
  bahawalpur: {
    priceTable: {
      title: "Used Cars Price in Bahawalpur",
      rows: [
        { model: "Suzuki Alto", priceRange: "Varies by model, year and condition" },
        { model: "Honda City", priceRange: "Varies by model, year and condition" },
        { model: "Toyota Corolla", priceRange: "Varies by model, year and condition" },
    ...
    intro:
      "Used car prices in Bahawalpur vary according to the model, manufacturing year, mileage, variant and overall condition. Buyers can compare different options according to their budget and driving needs.",
    sections: [
      {
        heading: "Used Cars for Sale in Bahawalpur",
        paragraphs: [
          "Looking for cars for sale in Bahawalpur? Explore a range of used cars from different brands and price categories. Whether you need a car for daily commuting, family travel or business use, you can compare available options and find a suitable vehicle.",
          "Bahawalpur buyers can explore hatchbacks, sedans and SUVs according to their requirements. Check the car's condition, documents and ownership details before finalizing a purchase.",
        ],
      },
      {
        heading: "Find the Right Used Car in Bahawalpur",
        paragraphs: [
          "Buying a used car in Bahawalpur becomes easier when you compare different listings and understand their features. Consider your budget, preferred model, fuel type, transmission and intended use before shortlisting a car.",
          "Inspect the vehicle carefully and verify its documents before making a deal. A proper comparison can help you make a more informed decision.",
        ],
      },
    ],
    faqs: [
      {
        question: "Which cars are popular in Bahawalpur?",
        answer:
          "Popular options include Suzuki Alto, Honda City, Toyota Corolla, Suzuki Cultus and Toyota Yaris.",
      },
      {
      ...
      {
        question: "Can I find affordable cars in Bahawalpur?",
        answer:
          "Yes, buyers can explore used cars in different price categories according to their budget.",
      },
    ],
  ...
  mardan: {
    priceTable: {
      title: "Used Cars Price in Mardan",
      rows: [
        { model: "Suzuki Alto", priceRange: "Varies by model, year and condition" },
        { model: "Toyota Corolla", priceRange: "Varies by model, year and condition" },
        { model: "Honda City", priceRange: "Varies by model, year and condition" },
    ...
    intro:
      "Used car prices in Mardan depend on the model, year, mileage, variant and overall condition. Buyers can compare different vehicles to find an option that suits their budget and driving requirements.",
    sections: [
      {
        heading: "Used Cars for Sale in Mardan",
        paragraphs: [
          "Looking for cars for sale in Mardan? Explore a variety of used cars from different brands and price categories. Whether you need a fuel-efficient car for daily travel, a family vehicle or a car for longer journeys, you can compare available options.",
          "Mardan buyers can explore hatchbacks, sedans and SUVs according to their needs. Check the vehicle's condition, documents, registration and ownership details before purchasing.",
        ],
      },
      {
        heading: "Find the Right Used Car in Mardan",
        paragraphs: [
          "Choosing a used car in Mardan starts with understanding your budget and requirements. Consider the model year, mileage, fuel type, transmission and maintenance needs before shortlisting a vehicle.",
          "You can also compare different listings, inspect the car and verify its documents before finalizing a deal. These steps can help you choose a suitable used car.",
        ],
      },
    ],
    faqs: [
      {
        question: "What types of used cars are available in Mardan?",
        answer:
          "You can find hatchbacks, sedans, SUVs and other used cars in different price categories.",
      },
      {
  ...
  gujrat: {
    priceTable: {
      title: "Used Cars Price in Gujrat",
      rows: [
        { model: "Suzuki Alto", priceRange: "Varies by model, year and condition" },
        { model: "Honda City", priceRange: "Varies by model, year and condition" },
        { model: "Toyota Corolla", priceRange: "Varies by model, year and condition" },
    ...
    intro:
      "Used car prices in Gujrat depend on the model, year, mileage, variant and overall condition. Buyers can compare different vehicles to find an option that suits their budget and driving requirements.",
    sections: [
      {
        heading: "Used Cars for Sale in Gujrat",
        paragraphs: [
          "Looking for cars for sale in Gujrat? Explore a variety of used cars from different brands and price categories. Whether you need a fuel-efficient car for daily travel, a family vehicle or a car for longer journeys, you can compare available options.",
          "Gujrat buyers can explore hatchbacks, sedans and SUVs according to their needs. Check the vehicle's condition, documents, registration and ownership details before purchasing.",
        ],
      },
      {
        heading: "Find the Right Used Car in Gujrat",
        paragraphs: [
          "Choosing a used car in Gujrat starts with understanding your budget and requirements. Consider the model year, mileage, fuel type, transmission and maintenance needs before shortlisting a vehicle.",
          "You can also compare different listings, inspect the car and verify its documents before finalizing a deal. These steps can help you choose a suitable used car.",
        ],
      },
    ],
    faqs: [
      {
        question: "What types of used cars are available in Gujrat?",
        answer:
          "You can find hatchbacks, sedans, SUVs and other used cars in different price categories.",
      },
      {
  ...
  sahiwal: {
    priceTable: {
      title: "Used Cars Price in Sahiwal",
      rows: [
        { model: "Suzuki Alto", priceRange: "Varies by model, year and condition" },
        { model: "Honda City", priceRange: "Varies by model, year and condition" },
        { model: "Toyota Corolla", priceRange: "Varies by model, year and condition" },
    ...
    intro:
      "Used car prices in Sahiwal vary according to the model, manufacturing year, mileage, variant and overall condition. Buyers can explore different options according to their budget and driving needs.",
    sections: [
      {
        heading: "Used Cars for Sale in Sahiwal",
        paragraphs: [
          "Looking for cars for sale in Sahiwal? Explore a range of used cars from different brands and price categories. Whether you need a car for daily commuting, family travel or business use, you can compare available options and find a suitable vehicle.",
          "Sahiwal buyers can explore hatchbacks, sedans and SUVs according to their requirements. Check the car's condition, documents and ownership details before finalizing a purchase.",
        ],
      },
      {
        heading: "Find the Right Used Car in Sahiwal",
        paragraphs: [
          "Buying a used car in Sahiwal becomes easier when you compare different listings and understand their features. Consider your budget, preferred model, fuel type, transmission and intended use before shortlisting a car.",
          "Inspect the vehicle carefully and verify its documents before making a deal. A proper comparison can help you make a more informed decision.",
        ],
      },
    ],
    faqs: [
      {
        question: "Which cars are popular in Sahiwal?",
        answer:
          "Popular options include Suzuki Alto, Honda City, Toyota Corolla, Suzuki Cultus and Toyota Yaris.",
      },
      {
      ...
      {
        question: "Can I find affordable cars in Sahiwal?",
        answer:
          "Yes, buyers can explore used cars in different price categories according to their budget.",
      },
    ],
