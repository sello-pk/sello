          ...
          <div className="w-full md:w-[60%] py-10 md:py-0 md:pr-6 lg:pr-10">
            ...
            <div className="flex items-center flex-wrap my-7 gap-5">
              <button
                ...
                className="px-6 w-48 py-3 rounded-lg border-[1px] flex items-center justify-center gap-3 bg-primary text-white border-transparent hover:bg-white hover:text-black transition-colors ease-in"
              >
                Browse Blogs
              ...
              <button
                ...
                className="px-6 w-48 py-3 rounded-lg border-[1px] flex items-center justify-center gap-3 border-black text-black hover:bg-primary hover:text-white transition-colors ease-in bg-white"
              >
                Contact
                <LuArrowUpRight size={20} />
              </button>
