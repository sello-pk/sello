        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="mt-1 px-3 py-2 rounded-lg border bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200">
          ...
          <div>
            ...
            <p className="text-gray-700 dark:text-gray-200">{role.purpose}</p>
          </div>
