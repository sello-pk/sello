                  ...
                  {savedValuations.map((valuation) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-500">
                        {new Date(valuation.created_date).toLocaleDateString()}
                      </div>
                    </motion.div>
                  ))}
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-8 md:order-1">
              ...
              <p className="text-gray-600 leading-relaxed">
                Here's the deal: our AI checks out your car's details stuff like
                mileage engine health body shape, and how well it's been cared
                for. Then it runs the numbers to figure out a fair market price.
                No complicated tech talk just a straightforward look at what
                really matters.
              </p>
        ...
        >
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-8 md:order-1">
              ...
              <p className="text-gray-600 leading-relaxed">
                Let's be honest: not everything about your car matters to buyers
                but some things really do. Mileage engine condition the paint
                job interior suspension tire quality and whether it's been in an
                accident these are the big ones. Buyers pay attention to this
                stuff because it tells them how the car's been treated and what
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                That means you get a price that's consistent fair and not swayed
                by anyone's opinion. It's just more reliable.
              </p>
