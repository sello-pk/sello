...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#050B20] text-white relative z-10 w-full min-w-0">
      <div className="max-w-8xl w-full min-w-0 mx-auto px-3 sm:px-4 md:px-6 lg:px-8 pt-6 sm:pt-8 pb-16">
        {/* Main Footer Content */}
