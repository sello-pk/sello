    ...
    <div className="space-y-6">
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
          <li>
            <strong>View All Listings:</strong> See all your active, pending,
            and sold listings
          </li>
          <li>
            <strong>Edit Listings:</strong> Update details, photos, or price
            anytime
          </li>
          <li>
            <strong>Delete Listings:</strong> Remove listings that are no longer
            available
          </li>
          <li>
            <strong>Mark as Sold:</strong> Update listing status when vehicle is
            sold
          </li>
          <li>
            <strong>Boost Listings:</strong> Promote your listings for better
            visibility
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700 mb-4">Organize your dashboard:</p>
        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
