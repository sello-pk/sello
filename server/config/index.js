...
export const FEATURE_CONFIG = {
  ...
  AUCTION_ACCESS_ENFORCEMENT: process.env.AUCTION_ACCESS_ENFORCEMENT || "off", // off | soft | hard
  AUCTION_ACCESS_GRACE_DAYS: parseInt(process.env.AUCTION_ACCESS_GRACE_DAYS || "14"),
};
