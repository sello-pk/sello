  ...
  try {
    ...
    const config = {
      ...
      responses: {
        ...
        default:
          "Could you please rephrase your request? An agent will be with you shortly.",
      },
    };
...
export const updateChatbotConfig = async (req, res) => {
  try {
    ...
    const { enabled, welcomeMessage, autoResponse, workingHours, responses } =
      req.body;
    ...
    const config = {
      ...
      responses: responses || {
        ...
        help: "We can help you with car listings, pricing, and general inquiries.",
        default:
          "An agent will be with you shortly. How can we help you today?",
      },
      updatedAt: new Date(),
...
export const createQuickReply = async (req, res) => {
  try {
    ...
    const populated = await QuickReply.findById(quickReply._id).populate(
      "createdBy",
      "name email",
    );
